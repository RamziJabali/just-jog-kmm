...
@class SharedJustJogBottomNavigationItems, SharedKotlinArray<T>, SharedKotlinEnum<E>, SharedKotlinEnumCompanion, SharedLibraryDrawableResource, SharedLibraryResource, SharedLibraryResourceItem, UIViewController;

@protocol SharedKotlinComparable, SharedKotlinIterator, SharedLibraryQualifier, SharedPlatform;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JustJogBottomNavigationItems")))
@interface SharedJustJogBottomNavigationItems : SharedKotlinEnum<SharedJustJogBottomNavigationItems *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedJustJogBottomNavigationItems *statisticsBottomNavItem __attribute__((swift_name("statisticsBottomNavItem")));
@property (class, readonly) SharedJustJogBottomNavigationItems *calendarBottomNavItem __attribute__((swift_name("calendarBottomNavItem")));
+ (SharedKotlinArray<SharedJustJogBottomNavigationItems *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<SharedJustJogBottomNavigationItems *> *entries __attribute__((swift_name("entries")));
@property (readonly) SharedLibraryDrawableResource *icon __attribute__((swift_name("icon")));
@property (readonly) int32_t index __attribute__((swift_name("index")));
@property (readonly) NSString *itemName __attribute__((swift_name("itemName")));
@end
